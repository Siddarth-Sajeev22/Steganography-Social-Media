...
export function mainModule() {
    ...
    function updateScale() {
        ...
        // The condition checks if the target element is outside the current viewport.
    ...
    // );
    let mask;
    const objloader = new FBXLoader().setPath('https://miroleon.github.io/daily-assets/');
    objloader.load('MASK_02.fbx', function (object) {

        mask = object.children[0];
        mask.position.set(0, -0.2, 0);
        mask.scale.setScalar(2);
        mask.material = material1;
        group.add(mask);
    });
